<?php
    ...
    <head>
        ...
        <title>문서</title>
        <link rel="stylesheet" href="./css/list_otter_sbw.css">
    </head>
    <body>
        <div class="container">
            <div class="side">
            ...
            <div class="folder">
                ...
                <div class="folder_main">
                    ...
                    <div class="insert-list">
                        ...
                        <a href="./list_otter_sbw.php?page=<?php echo $prev_page_num ?>" class ="number_button">이전</a>
                        ...
                        <a href="./list_otter_sbw.php?page=<?php echo $num ?>" class ="number_button <?php echo($num === (int)$page_num) ? "color_btn" : "" ?> "><?php echo $num ?></a>
                        ...
                        ?>
                        <a href="./list_otter_sbw.php?page=<?php echo $next_page_num?>" class ="number_button">다음</a>
                    </div>
                    </div>
                </div>
            </div>
